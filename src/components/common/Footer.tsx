      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-brown-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-brown-400 text-sm">
            © {currentYear} OnboardEase. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
            <span className="text-brown-400 text-sm">Built for startups that move fast</span>
            <span className="text-brown-600">•</span>
            <span className="text-brown-400 text-sm">SOC 2 | GDPR | CCPA</span>
          </div>
        </div>
      </div>
    </footer>
