...
// HR sees same sections as Admin but without Integrations
const navItems = [
    ...
    <div className="flex min-h-screen" style={{ background: '#F0F7FF' }}>
      ...
      <div className="flex-1 min-w-0 flex flex-col">
        ...
        <main className="flex-1 overflow-y-auto">
          {/* isHR=true: hides add/remove employee & mentor, filters docs to HR-uploaded only */}
          <AdminPanel activeSection={active} isHR={true} />
        </main>
      </div>
